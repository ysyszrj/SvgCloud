 ...
 * Version 1.0.0
 *
 * modefied the code of jQCloud(https://github.com/lucaong/)
*/
  ...
  $.fn.SvgCloud = function(word_array, options) {
    ...
    var drawWordCloud = function() {
      ...
      var drawOneWord = function(index, word) {
        ...
        word_span =svg.append("g").attr("class","wd").append("text").attr("class",'w' + weight + " " + custom_class)
            .attr("id",word.html.id).attr("fill",options.font_color).style("font-size",weight*5);
